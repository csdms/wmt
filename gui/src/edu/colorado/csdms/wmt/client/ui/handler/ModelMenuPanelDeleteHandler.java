 ...
 */
public class ModelMenuPanelDeleteHandler implements ClickHandler {

  private DataManager data;
  private DroplistDialogBox deleteDialog;

  /**
   * Creates a new instance of {@link ModelMenuPanelDeleteHandler}.
   * 
   * @param data the DataManager object for the WMT session
   */
  public ModelMenuPanelDeleteHandler(DataManager data) {
    this.data = data;
  }
